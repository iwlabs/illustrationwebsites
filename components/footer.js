...
const navigation = {
  ...
  services: [
    { name: 'Theme Customization & Development', href: '#' },
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm font-semibold text-slate-400 tracking-wider uppercase">Navigation</h3>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-12 md:mt-0">
                <h3 className="text-sm font-semibold text-slate-400 tracking-wider uppercase">More</h3>
                <ul role="list" className="mt-4 space-y-4">
          ...
          <div className="mt-8 xl:mt-0">
            ...
            <form className="mt-4 sm:flex sm:max-w-md">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="appearance-none min-w-0 w-full bg-white border border-slate-300 rounded-md shadow-sm py-2 px-4 text-base text-slate-900 placeholder-slate-500 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:placeholder-slate-400"
